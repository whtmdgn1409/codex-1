...
- 완료: `CRAWL-003` API-Football 적재 확장
  - `teams`, `players`, `matches`, `match_stats`, `standings` 수집/적재 구현
  - standings API 빈 응답 시 fixtures 기반 순위 fallback 계산 반영
  - CI live 검증 성공 (`API-Football Live Verify` run `22037648969`)
...
## D) Done Log
- 2026-02-15
  - `CRAWL-003` 최종 완료: `API-Football Live Verify` CI 성공(`run 22037648969`)
  - `standings` 빈 응답 대응: fixtures 기반 순위 fallback 로직 추가
- 2026-02-15
